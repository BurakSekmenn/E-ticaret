              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td style="width:110px; height: 10px; "><?php echo $slidercek['urun_baslik'] ?></td>
                    ...
                    <td><a href="coklu-resim?urunid=<?php echo $slidercek['urun_id'] ?>"><button style="width:100px; height: 60px; " class="btn btn-success">Resim Ekle</button></a>
                    <br><br>
                        <a href="resim-sil?urunid=<?php echo $slidercek['urun_id'] ?>" ><button style="width:100px; height: 60px; " class="btn btn-success">Resimleri Düzenle</button></a>
